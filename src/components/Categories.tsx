...
import { BookOpen, Skull, Play, Pickaxe } from "lucide-react";
...
const icons = [BookOpen, Skull, Play, Pickaxe];
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {t.categories.items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-accent/10 flex items-center justify-center mb-5 transition-transform duration-300 group-hover:scale-110 group-hover:bg-accent/15">
